    ...
    <div className="flex flex-col min-h-full">
      ...
      <div className="sticky top-0 z-10 bg-background border-b border-border/10">
        <div className="max-w-5xl mx-auto px-4 pt-3 md:pt-4 pb-0">
          <div className="flex items-center justify-between mb-2 md:mb-3 lg:justify-end lg:mb-0">
            <h1 className="text-3xl sm:text-4xl font-bold uppercase font-[var(--br-heading-font)] tracking-tight lg:hidden">
              STUDY
            </h1>
